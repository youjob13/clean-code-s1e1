...
var createNewTaskElement=function(taskString){
    ...
    label.classList.add("task__content_not-editable");
    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.classList.add("input_checkbox");
    editInput.type="text";
    editInput.classList.add("task__content");
    ...
    deleteButtonImg.classList.add("task__delete_img");
...
var editTask=function(){
    ...
    var label=listItem.querySelector(".task__content_not-editable");
